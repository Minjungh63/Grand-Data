            ...
            if($res){
                ...
                $i=0;
                    do{
                      ...
                      </svg></th><td onclick=\"location.href='Main5_update.php?key=".$director_list["movie_id"]."&&name=".$c1."&&state=write'\"><svg xmlns='http://www.w3.org/2000/svg' style='margin-left:2 0px;' width='18' height='18' fill='currentColor' class='bi bi-pencil-fill' viewBox='0 0 16 16'>
